...
export const SkillContainer = ({ skill_list, header }: { skill_list: Skill[], header: string }) => {
    return <div className="w-fit flex flex-col items-center space-y-4 bg-slate-800 p-2.5 rounded-md ">
        <h1 className="text-white font-bold text-[30px]">{header} </h1>
        <ul className="grid grid-cols-2 w-fit gap-10 place-items-center justify-center items-center">
