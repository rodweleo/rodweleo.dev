...
const Homepage = () => {
  ...
  return (
    <main className="w-full relative">
      ...
      <Projects />
      <ContactMe />
      <div id={homeNavContainerId} className="w-fit fixed bg-slate-800 top-1/2 left-0 h-fit flex flex-col p-2.5 justify-center gap-6 text-slate-300 rounded-r-md hidden">
